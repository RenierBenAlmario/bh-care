-- HEEADSSS Assessment Encryption Migration
...
ADD 
    ...
    [FamilyNoEncrypted] [nvarchar](max) NULL;
...
EXEC sp_rename '[dbo].[HEEADSSSAssessments].[FamilyNoEncrypted]', 'FamilyNo', 'COLUMN';
