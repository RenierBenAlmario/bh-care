...
namespace Barangay.Migrations
{
    ...
    [Migration("20250528174550_AddNCDRiskAssessmentTable")]
    partial class AddNCDRiskAssessmentTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Barangay.Models.NCDRiskAssessment", b =>
                {
                    b.HasOne("Barangay.Models.Appointment", "Appointment")
                        .WithOne()
                        .HasForeignKey("Barangay.Models.NCDRiskAssessment", "AppointmentId")
